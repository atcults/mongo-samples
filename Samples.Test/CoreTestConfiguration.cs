...
namespace Samples.Tests
{
    public static class CoreTestConfiguration
    {
        ...
        private static Lazy<ConnectionString> __connectionStringWithMultipleShardRouters = new Lazy<ConnectionString>(GetConnectionStringWithMultipleShardRouters, isThreadSafe: true);
