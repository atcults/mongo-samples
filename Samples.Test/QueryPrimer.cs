...
namespace Samples.Tests
{
    ...
    {
        public QueryPrimer(ITestOutputHelper output) : base(output, false)
        {
        ...
        public async Task QueryAll()
        {
            ...
            var totalDocs = await collection.Find(filter).CountDocumentsAsync();
            totalDocs.Should().Be(25359);

            Output.WriteLine($"Total time: {watch.ElapsedMilliseconds}");
